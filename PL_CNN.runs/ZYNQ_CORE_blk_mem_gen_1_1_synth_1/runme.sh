...
HD_PWD='D:/Programs/Workspace/Xilinx_Prj/PL_CNN/PL_CNN.runs/ZYNQ_CORE_blk_mem_gen_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_blk_mem_gen_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_blk_mem_gen_1_1.tcl
