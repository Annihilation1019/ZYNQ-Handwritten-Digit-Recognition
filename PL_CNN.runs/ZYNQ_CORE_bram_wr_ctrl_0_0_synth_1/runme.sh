...
HD_PWD='D:/Programs/Workspace/Xilinx_Prj/PL_CNN/PL_CNN.runs/ZYNQ_CORE_bram_wr_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_bram_wr_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_bram_wr_ctrl_0_0.tcl
