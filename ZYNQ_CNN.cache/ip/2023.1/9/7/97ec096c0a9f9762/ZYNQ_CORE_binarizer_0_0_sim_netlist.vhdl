...
bin_data_flag_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"74"
    )
        port map (
...
\rgb_data_out[23]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
