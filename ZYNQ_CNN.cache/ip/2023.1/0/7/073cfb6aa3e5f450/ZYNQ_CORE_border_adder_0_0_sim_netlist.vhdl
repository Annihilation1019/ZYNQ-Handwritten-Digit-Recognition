...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_border_adder is
  ...
  attribute SOFT_HLUTNM of \rgb_data_out[23]_i_11\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rgb_data_out[23]_i_14\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rgb_data_out[23]_i_15\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rgb_data_out[23]_i_17\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rgb_data_out[23]_i_20\ : label is "soft_lutpair2";
...
\rgb_data_out[23]_i_12\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
\rgb_data_out[23]_i_15\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\rgb_data_out[23]_i_16\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\rgb_data_out[23]_i_18\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\rgb_data_out[23]_i_20\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\rgb_data_out[23]_i_21\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E000"
    )
        port map (
...
\rgb_data_out[23]_i_22\: unisim.vcomponents.LUT6
    generic map(
...
\rgb_data_out[23]_i_23\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\rgb_data_out[23]_i_24\: unisim.vcomponents.LUT6
    generic map(
