...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_binarizer is
  ...
  signal rgb_data_out3 : STD_LOGIC;
  signal rgb_data_out40_in : STD_LOGIC;
  ...
  attribute COMPARATOR_THRESHOLD of rgb_data_out1_carry : label is 11;
  ...
  attribute HLUTNM of \weighted_sum1__86_carry__0_i_1\ : label is "lutpair4";
  attribute HLUTNM of \weighted_sum1__86_carry__0_i_2\ : label is "lutpair3";
  attribute HLUTNM of \weighted_sum1__86_carry__0_i_5\ : label is "lutpair4";
  attribute HLUTNM of \weighted_sum1__86_carry__0_i_6\ : label is "lutpair3";
...
bin_data_flag_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80FF8000"
    )
        port map (
...
\rgb_data_out[23]_i_4\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \rgb_data_out[23]_i_9_n_0\,
      I2 => pixel_x_reg(9),
      I3 => \rgb_data_out[23]_i_10_n_0\,
      I4 => pixel_x_reg(8),
...
\rgb_data_out[23]_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\weighted_sum0__24_carry__0_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => rgb_data_in(4),
      I3 => rgb_data_in(7),
      I4 => \weighted_sum0_carry__1_n_2\,
      I5 => rgb_data_in(5),
      O => \weighted_sum0__24_carry__0_i_5_n_0\
    );
\weighted_sum0__24_carry__0_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D42B2BD42BD4D42B"
    )
        port map (
      ...
      I2 => rgb_data_in(3),
      I3 => rgb_data_in(6),
      I4 => \weighted_sum0_carry__1_n_7\,
      I5 => rgb_data_in(4),
      O => \weighted_sum0__24_carry__0_i_6_n_0\
    );
\weighted_sum0__24_carry__0_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D42B2BD42BD4D42B"
    )
        port map (
      ...
      I2 => rgb_data_in(2),
      I3 => rgb_data_in(5),
      I4 => \weighted_sum0_carry__0_n_4\,
      I5 => rgb_data_in(3),
      O => \weighted_sum0__24_carry__0_i_7_n_0\
    );
\weighted_sum0__24_carry__0_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D42B2BD42BD4D42B"
    )
        port map (
...
\weighted_sum0__24_carry__1_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8E"
    )
        port map (
...
\weighted_sum0__24_carry_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D42B2BD42BD4D42B"
    )
        port map (
...
\weighted_sum1__86_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => rgb_data_in(10),
      I1 => rgb_data_in(13),
      I2 => \weighted_sum1__58_carry__1_n_7\,
...
\weighted_sum1__86_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => rgb_data_in(9),
      I1 => rgb_data_in(12),
      I2 => \weighted_sum1__58_carry__0_n_4\,
...
\weighted_sum1__86_carry__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
        ...
        port map (
      I0 => \weighted_sum1__86_carry__0_i_1_n_0\,
...
\weighted_sum1__86_carry__1_i_4\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => rgb_data_in(11),
      I1 => rgb_data_in(14),
      I2 => \weighted_sum1__58_carry__1_n_6\,
...
\weighted_sum1__86_carry__1_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E81717E817E8E817"
    )
        port map (
      I0 => \weighted_sum1__58_carry__1_n_6\,
      I1 => rgb_data_in(14),
      I2 => rgb_data_in(11),
      I3 => rgb_data_in(15),
      I4 => \weighted_sum1__58_carry__1_n_1\,
      I5 => rgb_data_in(12),
