...
#                script (type 'rom_w2_ip.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rom_w2_ip xil_defaultlib.glbl -o rom_w2_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rom_w2_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rom_w2_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rom_w2_ip_simv.daidir vcs_lib c.obj)
