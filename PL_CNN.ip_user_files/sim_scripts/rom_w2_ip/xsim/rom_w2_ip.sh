...
#
# Script generated by Vivado on Fri Mar 28 17:09:52 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : rom_w2_ip.sh
...
#
# Usage        : rom_w2_ip.sh
#                rom_w2_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom_w2_ip.sh [-reset_run]
#                rom_w2_ip.sh [-reset_log]
#                rom_w2_ip.sh [-help]
#
...
# script info
echo -e "rom_w2_ip.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom_w2_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom_w2_ip xil_defaultlib.rom_w2_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rom_w2_ip -key {Behavioral:sim_1:Functional:rom_w2_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/ZYNQ_CORE.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rom_w2_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rom_w2_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rom_w2_ip.sh [-help]\n\
Usage: rom_w2_ip.sh [-step]\n\
Usage: rom_w2_ip.sh [-lib_map_path]\n\
Usage: rom_w2_ip.sh [-reset_run]\n\
Usage: rom_w2_ip.sh [-reset_log]\n\
Usage: rom_w2_ip.sh [-keep_index]\n\
Usage: rom_w2_ip.sh [-noclean_files]\n\n\
