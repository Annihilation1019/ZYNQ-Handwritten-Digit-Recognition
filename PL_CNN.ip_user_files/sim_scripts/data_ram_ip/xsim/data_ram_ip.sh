...
#
# Script generated by Vivado on Fri Mar 28 16:57:39 +0800 2025
...
#
# Usage        : data_ram_ip.sh
#                data_ram_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                data_ram_ip.sh [-reset_run]
#                data_ram_ip.sh [-reset_log]
#                data_ram_ip.sh [-help]
#
...
# script info
echo -e "data_ram_ip.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./data_ram_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_ram_ip xil_defaultlib.data_ram_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_ram_ip -key {Behavioral:sim_1:Functional:data_ram_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/ZYNQ_CORE.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb data_ram_ip.wdb xsim.dir libdpi.so)
...
Usage: data_ram_ip.sh [-step]\n\
Usage: data_ram_ip.sh [-lib_map_path]\n\
Usage: data_ram_ip.sh [-reset_run]\n\
Usage: data_ram_ip.sh [-reset_log]\n\
Usage: data_ram_ip.sh [-keep_index]\n\
