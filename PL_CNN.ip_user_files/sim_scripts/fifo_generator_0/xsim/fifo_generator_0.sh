...
#
# Script generated by Vivado on Fri Mar 28 17:00:46 +0800 2025
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ZYNQ_CORE.protoinst" -log simulate.log
}
