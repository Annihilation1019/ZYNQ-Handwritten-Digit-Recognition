...
#
# Script generated by Vivado on Fri Mar 28 17:03:04 +0800 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_gen_0 xil_defaultlib.mult_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_gen_0 -key {Behavioral:sim_1:Functional:mult_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ZYNQ_CORE.protoinst" -log simulate.log
}
